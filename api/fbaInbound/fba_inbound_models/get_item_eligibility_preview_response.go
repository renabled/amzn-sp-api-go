...
func (m *GetItemEligibilityPreviewResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetItemEligibilityPreviewResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetItemEligibilityPreviewResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetItemEligibilityPreviewResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetItemEligibilityPreviewResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetItemEligibilityPreviewResponse) UnmarshalBinary(b []byte) error {
	var res GetItemEligibilityPreviewResponse
