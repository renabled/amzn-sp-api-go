...
// WithMarketplaceID adds the marketplaceID to the create transaction params
func (o *CreateTransactionParams) WithMarketplaceID(marketplaceID string) *CreateTransactionParams {
	o.SetMarketplaceID(marketplaceID)
	return o
}

// SetMarketplaceID adds the marketplaceId to the create transaction params
func (o *CreateTransactionParams) SetMarketplaceID(marketplaceID string) {
