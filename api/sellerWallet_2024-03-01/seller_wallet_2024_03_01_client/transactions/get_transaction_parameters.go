...
// WithMarketplaceID adds the marketplaceID to the get transaction params
func (o *GetTransactionParams) WithMarketplaceID(marketplaceID string) *GetTransactionParams {
	o.SetMarketplaceID(marketplaceID)
	return o
}

// SetMarketplaceID adds the marketplaceId to the get transaction params
func (o *GetTransactionParams) SetMarketplaceID(marketplaceID string) {
