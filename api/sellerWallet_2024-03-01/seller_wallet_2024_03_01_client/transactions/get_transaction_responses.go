...
func (o *GetTransactionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 408:
		result := NewGetTransactionRequestTimeout()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 413:
		result := NewGetTransactionRequestEntityTooLarge()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetTransactionOK) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionOK  %+v", 200, o.Payload)
}
...
func (o *GetTransactionOK) GetPayload() *seller_wallet_2024_03_01_models.Transaction {
	return o.Payload
}
...
func (o *GetTransactionBadRequest) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetTransactionBadRequest) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetTransactionForbidden) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionForbidden  %+v", 403, o.Payload)
}
...
func (o *GetTransactionForbidden) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetTransactionNotFound) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionNotFound  %+v", 404, o.Payload)
}
...
func (o *GetTransactionNotFound) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
// NewGetTransactionRequestTimeout creates a GetTransactionRequestTimeout with default headers values
func NewGetTransactionRequestTimeout() *GetTransactionRequestTimeout {
	return &GetTransactionRequestTimeout{}
}

/*
GetTransactionRequestTimeout describes a response with status code 408, with default header values.

Request Timed Out.
*/
type GetTransactionRequestTimeout struct {
...
// IsSuccess returns true when this get transaction request timeout response has a 2xx status code
func (o *GetTransactionRequestTimeout) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get transaction request timeout response has a 3xx status code
func (o *GetTransactionRequestTimeout) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get transaction request timeout response has a 4xx status code
func (o *GetTransactionRequestTimeout) IsClientError() bool {
	return true
}

// IsServerError returns true when this get transaction request timeout response has a 5xx status code
func (o *GetTransactionRequestTimeout) IsServerError() bool {
	return false
}

// IsCode returns true when this get transaction request timeout response a status code equal to that given
func (o *GetTransactionRequestTimeout) IsCode(code int) bool {
	return code == 408
}

func (o *GetTransactionRequestTimeout) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionRequestTimeout  %+v", 408, o.Payload)
}

func (o *GetTransactionRequestTimeout) String() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionRequestTimeout  %+v", 408, o.Payload)
}

func (o *GetTransactionRequestTimeout) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}

func (o *GetTransactionRequestTimeout) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
// NewGetTransactionRequestEntityTooLarge creates a GetTransactionRequestEntityTooLarge with default headers values
func NewGetTransactionRequestEntityTooLarge() *GetTransactionRequestEntityTooLarge {
	return &GetTransactionRequestEntityTooLarge{}
}

/*
GetTransactionRequestEntityTooLarge describes a response with status code 413, with default header values.

The request size exceeded the maximum accepted size.
*/
type GetTransactionRequestEntityTooLarge struct {
...
// IsSuccess returns true when this get transaction request entity too large response has a 2xx status code
func (o *GetTransactionRequestEntityTooLarge) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get transaction request entity too large response has a 3xx status code
func (o *GetTransactionRequestEntityTooLarge) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get transaction request entity too large response has a 4xx status code
func (o *GetTransactionRequestEntityTooLarge) IsClientError() bool {
	return true
}

// IsServerError returns true when this get transaction request entity too large response has a 5xx status code
func (o *GetTransactionRequestEntityTooLarge) IsServerError() bool {
	return false
}

// IsCode returns true when this get transaction request entity too large response a status code equal to that given
func (o *GetTransactionRequestEntityTooLarge) IsCode(code int) bool {
	return code == 413
}

func (o *GetTransactionRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *GetTransactionRequestEntityTooLarge) String() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *GetTransactionRequestEntityTooLarge) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}

func (o *GetTransactionRequestEntityTooLarge) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetTransactionUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *GetTransactionUnsupportedMediaType) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetTransactionTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetTransactionTooManyRequests) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetTransactionInternalServerError) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetTransactionInternalServerError) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetTransactionServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/transactions/{transactionId}][%d] getTransactionServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *GetTransactionServiceUnavailable) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
