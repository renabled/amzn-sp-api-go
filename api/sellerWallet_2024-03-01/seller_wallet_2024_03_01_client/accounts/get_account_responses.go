...
func (o *GetAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 408:
		result := NewGetAccountRequestTimeout()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
type GetAccountOK struct {
	...
	Payload *seller_wallet_2024_03_01_models.BankAccount
}
...
func (o *GetAccountOK) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountOK  %+v", 200, o.Payload)
}
...
func (o *GetAccountOK) GetPayload() *seller_wallet_2024_03_01_models.BankAccount {
	return o.Payload
}
...
func (o *GetAccountOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(seller_wallet_2024_03_01_models.BankAccount)
...
func (o *GetAccountBadRequest) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetAccountBadRequest) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetAccountForbidden) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountForbidden  %+v", 403, o.Payload)
}
...
func (o *GetAccountForbidden) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetAccountNotFound) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountNotFound  %+v", 404, o.Payload)
}
...
func (o *GetAccountNotFound) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
// NewGetAccountRequestTimeout creates a GetAccountRequestTimeout with default headers values
func NewGetAccountRequestTimeout() *GetAccountRequestTimeout {
	return &GetAccountRequestTimeout{}
}

/*
GetAccountRequestTimeout describes a response with status code 408, with default header values.

Request Timed Out.
*/
type GetAccountRequestTimeout struct {
...
// IsSuccess returns true when this get account request timeout response has a 2xx status code
func (o *GetAccountRequestTimeout) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get account request timeout response has a 3xx status code
func (o *GetAccountRequestTimeout) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get account request timeout response has a 4xx status code
func (o *GetAccountRequestTimeout) IsClientError() bool {
	return true
}

// IsServerError returns true when this get account request timeout response has a 5xx status code
func (o *GetAccountRequestTimeout) IsServerError() bool {
	return false
}

// IsCode returns true when this get account request timeout response a status code equal to that given
func (o *GetAccountRequestTimeout) IsCode(code int) bool {
	return code == 408
}

func (o *GetAccountRequestTimeout) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountRequestTimeout  %+v", 408, o.Payload)
}

func (o *GetAccountRequestTimeout) String() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountRequestTimeout  %+v", 408, o.Payload)
}

func (o *GetAccountRequestTimeout) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}

func (o *GetAccountRequestTimeout) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetAccountRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountRequestEntityTooLarge  %+v", 413, o.Payload)
}
...
func (o *GetAccountRequestEntityTooLarge) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetAccountUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *GetAccountUnsupportedMediaType) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetAccountTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetAccountTooManyRequests) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetAccountInternalServerError) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetAccountInternalServerError) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetAccountServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /finances/transfers/wallet/2024-03-01/accounts/{accountId}][%d] getAccountServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *GetAccountServiceUnavailable) GetPayload() *seller_wallet_2024_03_01_models.ErrorList {
	return o.Payload
}
