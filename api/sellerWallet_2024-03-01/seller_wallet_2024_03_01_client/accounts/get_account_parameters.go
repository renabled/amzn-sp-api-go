...
// WithMarketplaceID adds the marketplaceID to the get account params
func (o *GetAccountParams) WithMarketplaceID(marketplaceID string) *GetAccountParams {
	o.SetMarketplaceID(marketplaceID)
	return o
}

// SetMarketplaceID adds the marketplaceId to the get account params
func (o *GetAccountParams) SetMarketplaceID(marketplaceID string) {
