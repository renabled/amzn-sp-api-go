...
// WithMarketplaceID adds the marketplaceID to the list accounts params
func (o *ListAccountsParams) WithMarketplaceID(marketplaceID string) *ListAccountsParams {
	o.SetMarketplaceID(marketplaceID)
	return o
}

// SetMarketplaceID adds the marketplaceId to the list accounts params
func (o *ListAccountsParams) SetMarketplaceID(marketplaceID string) {
