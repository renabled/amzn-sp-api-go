...
const (
	...
	// TransactionStatusINITIATED captures enum value "INITIATED"
	...
	// TransactionStatusPAYEEUNDERREVIEW captures enum value "PAYEE_UNDER_REVIEW"
	TransactionStatusPAYEEUNDERREVIEW TransactionStatus = "PAYEE_UNDER_REVIEW"
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["FAILED","FAILED_CREDITS_APPLIED","INITIATED","IN_PROGRESS","PAYEE_UNDER_REVIEW","SUCCESSFUL"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
