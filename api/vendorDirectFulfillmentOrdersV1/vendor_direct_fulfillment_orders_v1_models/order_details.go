...
// OrderDetailsTaxTotal order details tax total
//
...
// Validate validates this order details tax total
func (m *OrderDetailsTaxTotal) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrderDetailsTaxTotal) validateTaxLineItem(formats strfmt.Registry) error {
	...
	if err := m.TaxLineItem.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("taxTotal" + "." + "taxLineItem")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("taxTotal" + "." + "taxLineItem")
		}
		return err
	}
...
// ContextValidate validate this order details tax total based on the context it is used
func (m *OrderDetailsTaxTotal) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OrderDetailsTaxTotal) contextValidateTaxLineItem(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *OrderDetailsTaxTotal) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *OrderDetailsTaxTotal) UnmarshalBinary(b []byte) error {
	var res OrderDetailsTaxTotal
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
