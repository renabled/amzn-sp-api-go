...
func (o *SubmitAcknowledgementParams) WithBody(body *vendor_direct_fulfillment_orders_v1_models.SubmitAcknowledgementRequest) *SubmitAcknowledgementParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the submit acknowledgement params
func (o *SubmitAcknowledgementParams) SetBody(body *vendor_direct_fulfillment_orders_v1_models.SubmitAcknowledgementRequest) {
	o.Body = body
}
