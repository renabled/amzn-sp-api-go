...
type SubmitInventoryUpdateParams struct {
	...
	// Body.
	Body *vendor_direct_fulfillment_orders_v1_models.SubmitInventoryUpdateRequest
...
func (o *SubmitInventoryUpdateParams) WithBody(body *vendor_direct_fulfillment_orders_v1_models.SubmitInventoryUpdateRequest) *SubmitInventoryUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the submit inventory update params
func (o *SubmitInventoryUpdateParams) SetBody(body *vendor_direct_fulfillment_orders_v1_models.SubmitInventoryUpdateRequest) {
	o.Body = body
}
