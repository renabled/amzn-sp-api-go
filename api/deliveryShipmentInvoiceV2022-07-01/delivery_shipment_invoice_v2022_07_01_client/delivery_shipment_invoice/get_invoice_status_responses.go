...
import (
	...
	"github.com/renabled/amzn-sp-api-go/api/deliveryShipmentInvoiceV2022-07-01/delivery_shipment_invoice_v2022_07_01_models"
)
...
func (o *GetInvoiceStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 413:
		result := NewGetInvoiceStatusRequestEntityTooLarge()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
type GetInvoiceStatusOK struct {
	...
	Payload *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse
}
...
func (o *GetInvoiceStatusOK) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusOK  %+v", 200, o.Payload)
}
...
func (o *GetInvoiceStatusOK) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse {
	return o.Payload
}
...
func (o *GetInvoiceStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse)
...
func (o *GetInvoiceStatusBadRequest) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetInvoiceStatusBadRequest) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse {
	return o.Payload
}
...
func (o *GetInvoiceStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetInvoiceStatusUnauthorized) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse {
	return o.Payload
}
...
func (o *GetInvoiceStatusForbidden) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusForbidden  %+v", 403, o.Payload)
}
...
func (o *GetInvoiceStatusForbidden) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse {
	return o.Payload
}
...
func (o *GetInvoiceStatusNotFound) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *GetInvoiceStatusNotFound) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse {
	return o.Payload
}
...
// NewGetInvoiceStatusRequestEntityTooLarge creates a GetInvoiceStatusRequestEntityTooLarge with default headers values
func NewGetInvoiceStatusRequestEntityTooLarge() *GetInvoiceStatusRequestEntityTooLarge {
	return &GetInvoiceStatusRequestEntityTooLarge{}
}

/*
GetInvoiceStatusRequestEntityTooLarge describes a response with status code 413, with default header values.

The request size exceeded the maximum accepted size.
*/
type GetInvoiceStatusRequestEntityTooLarge struct {

	/* Unique request reference identifier.
	 */
	XAmznRequestID string

	Payload delivery_shipment_invoice_v2022_07_01_models.ErrorList
}

// IsSuccess returns true when this get invoice status request entity too large response has a 2xx status code
func (o *GetInvoiceStatusRequestEntityTooLarge) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get invoice status request entity too large response has a 3xx status code
func (o *GetInvoiceStatusRequestEntityTooLarge) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get invoice status request entity too large response has a 4xx status code
func (o *GetInvoiceStatusRequestEntityTooLarge) IsClientError() bool {
	return true
}

// IsServerError returns true when this get invoice status request entity too large response has a 5xx status code
func (o *GetInvoiceStatusRequestEntityTooLarge) IsServerError() bool {
	return false
}

// IsCode returns true when this get invoice status request entity too large response a status code equal to that given
func (o *GetInvoiceStatusRequestEntityTooLarge) IsCode(code int) bool {
	return code == 413
}

func (o *GetInvoiceStatusRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *GetInvoiceStatusRequestEntityTooLarge) String() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *GetInvoiceStatusRequestEntityTooLarge) GetPayload() delivery_shipment_invoice_v2022_07_01_models.ErrorList {
	return o.Payload
}

func (o *GetInvoiceStatusRequestEntityTooLarge) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetInvoiceStatusUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *GetInvoiceStatusUnsupportedMediaType) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse {
	return o.Payload
}
...
func (o *GetInvoiceStatusTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetInvoiceStatusTooManyRequests) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse {
	return o.Payload
}
...
func (o *GetInvoiceStatusInternalServerError) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetInvoiceStatusInternalServerError) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse {
	return o.Payload
}
...
func (o *GetInvoiceStatusServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /delivery/2022-07-01/invoice/status][%d] getInvoiceStatusServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *GetInvoiceStatusServiceUnavailable) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.GetInvoiceStatusResponse {
	return o.Payload
}
