...
func (o *SubmitInvoiceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	case 401:
		result := NewSubmitInvoiceUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
type SubmitInvoiceOK struct {
	...
	Payload *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse
}
...
func (o *SubmitInvoiceOK) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceOK  %+v", 200, o.Payload)
}
...
func (o *SubmitInvoiceOK) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse {
	return o.Payload
}

func (o *SubmitInvoiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse)
...
func (o *SubmitInvoiceBadRequest) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceBadRequest  %+v", 400, o.Payload)
}
...
func (o *SubmitInvoiceBadRequest) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse {
	return o.Payload
}
...
func (o *SubmitInvoiceUnauthorized) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceUnauthorized  %+v", 401, o.Payload)
}
...
func (o *SubmitInvoiceUnauthorized) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse {
	return o.Payload
}

func (o *SubmitInvoiceUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *SubmitInvoiceForbidden) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceForbidden  %+v", 403, o.Payload)
}
...
func (o *SubmitInvoiceForbidden) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse {
	return o.Payload
}
...
func (o *SubmitInvoiceNotFound) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceNotFound  %+v", 404, o.Payload)
}
...
func (o *SubmitInvoiceNotFound) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse {
	return o.Payload
}
...
func (o *SubmitInvoiceRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceRequestEntityTooLarge  %+v", 413, o.Payload)
}
...
func (o *SubmitInvoiceRequestEntityTooLarge) GetPayload() delivery_shipment_invoice_v2022_07_01_models.ErrorList {
	return o.Payload
}
...
func (o *SubmitInvoiceUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *SubmitInvoiceUnsupportedMediaType) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse {
	return o.Payload
}
...
func (o *SubmitInvoiceTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *SubmitInvoiceTooManyRequests) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse {
	return o.Payload
}
...
func (o *SubmitInvoiceInternalServerError) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceInternalServerError  %+v", 500, o.Payload)
}
...
func (o *SubmitInvoiceInternalServerError) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse {
	return o.Payload
}
...
func (o *SubmitInvoiceServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /delivery/2022-07-01/invoice][%d] submitInvoiceServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *SubmitInvoiceServiceUnavailable) GetPayload() *delivery_shipment_invoice_v2022_07_01_models.SubmitInvoiceResponse {
	return o.Payload
}
