...
/*
	GetCustomerInvoice gets customer invoice
...
func (a *Client) GetCustomerInvoice(params *GetCustomerInvoiceParams, opts ...ClientOption) (*GetCustomerInvoiceOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/vendor/directFulfillment/shipping/2021-12-28/customerInvoices/{purchaseOrderNumber}",
...
/*
	GetCustomerInvoices gets customer invoices
...
func (a *Client) GetCustomerInvoices(params *GetCustomerInvoicesParams, opts ...ClientOption) (*GetCustomerInvoicesOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/vendor/directFulfillment/shipping/2021-12-28/customerInvoices",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
