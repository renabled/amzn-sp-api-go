...
func (a *Client) CreateShippingLabels(params *CreateShippingLabelsParams, opts ...ClientOption) (*CreateShippingLabelsOK, error) {
	...
	if params == nil {
		params = NewCreateShippingLabelsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "createShippingLabels",
		Method:             "POST",
		...
		Params:             params,
		Reader:             &CreateShippingLabelsReader{formats: a.formats},
	...
	success, ok := result.(*CreateShippingLabelsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for createShippingLabels: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
