...
func (m *UpdateSupplySourceStatusRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateSupplySourceStatusRequest) validateStatus(formats strfmt.Registry) error {
...
func (m *UpdateSupplySourceStatusRequest) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateSupplySourceStatusRequest) UnmarshalBinary(b []byte) error {
	var res UpdateSupplySourceStatusRequest
