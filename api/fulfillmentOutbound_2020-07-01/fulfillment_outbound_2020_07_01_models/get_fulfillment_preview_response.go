...
func (m *GetFulfillmentPreviewResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetFulfillmentPreviewResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetFulfillmentPreviewResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetFulfillmentPreviewResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetFulfillmentPreviewResponse) UnmarshalBinary(b []byte) error {
	var res GetFulfillmentPreviewResponse
