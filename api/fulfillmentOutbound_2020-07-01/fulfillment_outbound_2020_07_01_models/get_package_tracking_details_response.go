...
func (m *GetPackageTrackingDetailsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPackageTrackingDetailsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetPackageTrackingDetailsResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetPackageTrackingDetailsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetPackageTrackingDetailsResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetPackageTrackingDetailsResponse) UnmarshalBinary(b []byte) error {
	var res GetPackageTrackingDetailsResponse
