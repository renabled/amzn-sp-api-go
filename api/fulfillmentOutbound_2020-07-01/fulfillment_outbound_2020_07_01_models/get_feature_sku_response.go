...
func (m *GetFeatureSkuResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetFeatureSkuResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetFeatureSkuResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetFeatureSkuResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
