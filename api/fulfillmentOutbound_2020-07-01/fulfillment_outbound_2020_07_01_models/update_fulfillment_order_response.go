...
func (m *UpdateFulfillmentOrderResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *UpdateFulfillmentOrderResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateFulfillmentOrderResponse) UnmarshalBinary(b []byte) error {
	var res UpdateFulfillmentOrderResponse
