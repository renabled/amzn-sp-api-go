...
func (m *CreateFulfillmentOrderResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CreateFulfillmentOrderResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateFulfillmentOrderResponse) UnmarshalBinary(b []byte) error {
	var res CreateFulfillmentOrderResponse
