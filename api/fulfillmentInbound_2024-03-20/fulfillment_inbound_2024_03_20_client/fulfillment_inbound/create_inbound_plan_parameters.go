...
type CreateInboundPlanParams struct {
	...
	*/
	Body *fulfillment_inbound_2024_03_20_models.CreateInboundPlanRequest
...
func (o *CreateInboundPlanParams) WithBody(body *fulfillment_inbound_2024_03_20_models.CreateInboundPlanRequest) *CreateInboundPlanParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create inbound plan params
func (o *CreateInboundPlanParams) SetBody(body *fulfillment_inbound_2024_03_20_models.CreateInboundPlanRequest) {
	o.Body = body
}
