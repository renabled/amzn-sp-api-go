...
package fulfillment_inbound_2024_03_20_client
...
// NewHTTPClient creates a new fulfillment inbound20240320 HTTP client.
func NewHTTPClient(formats strfmt.Registry) *FulfillmentInbound20240320 {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new fulfillment inbound20240320 HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *FulfillmentInbound20240320 {
...
// New creates a new fulfillment inbound20240320 client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *FulfillmentInbound20240320 {
	// ensure nullable parameters have default
	if formats == nil {
