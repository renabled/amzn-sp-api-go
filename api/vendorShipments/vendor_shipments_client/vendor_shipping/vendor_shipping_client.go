...
type ClientService interface {
	...
	SubmitShipmentConfirmation(params *SubmitShipmentConfirmationParams, opts ...ClientOption) (*SubmitShipmentConfirmationAccepted, error)
...
/*
	GetShipmentDetails gets shipment details
...
The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
*/
func (a *Client) SubmitShipmentConfirmation(params *SubmitShipmentConfirmationParams, opts ...ClientOption) (*SubmitShipmentConfirmationAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	success, ok := result.(*SubmitShipmentConfirmationAccepted)
	if ok {
		return success, nil
	}
	// unexpected success response
...
/*
	SubmitShipments submits shipments
