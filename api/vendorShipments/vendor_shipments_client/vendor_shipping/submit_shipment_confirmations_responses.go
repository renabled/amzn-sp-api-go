...
func (o *SubmitShipmentConfirmationsAccepted) Error() string {
	return fmt.Sprintf("[POST /vendor/shipping/v1/shipmentConfirmations][%d] submitShipmentConfirmationsAccepted  %+v", 202, o.Payload)
}
...
func (o *SubmitShipmentConfirmationsBadRequest) Error() string {
	return fmt.Sprintf("[POST /vendor/shipping/v1/shipmentConfirmations][%d] submitShipmentConfirmationsBadRequest  %+v", 400, o.Payload)
}
...
func (o *SubmitShipmentConfirmationsForbidden) Error() string {
	return fmt.Sprintf("[POST /vendor/shipping/v1/shipmentConfirmations][%d] submitShipmentConfirmationsForbidden  %+v", 403, o.Payload)
}
...
func (o *SubmitShipmentConfirmationsNotFound) Error() string {
	return fmt.Sprintf("[POST /vendor/shipping/v1/shipmentConfirmations][%d] submitShipmentConfirmationsNotFound  %+v", 404, o.Payload)
}
...
func (o *SubmitShipmentConfirmationsRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[POST /vendor/shipping/v1/shipmentConfirmations][%d] submitShipmentConfirmationsRequestEntityTooLarge  %+v", 413, o.Payload)
}
...
func (o *SubmitShipmentConfirmationsUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[POST /vendor/shipping/v1/shipmentConfirmations][%d] submitShipmentConfirmationsUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *SubmitShipmentConfirmationsTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /vendor/shipping/v1/shipmentConfirmations][%d] submitShipmentConfirmationsTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *SubmitShipmentConfirmationsInternalServerError) Error() string {
	return fmt.Sprintf("[POST /vendor/shipping/v1/shipmentConfirmations][%d] submitShipmentConfirmationsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *SubmitShipmentConfirmationsServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /vendor/shipping/v1/shipmentConfirmations][%d] submitShipmentConfirmationsServiceUnavailable  %+v", 503, o.Payload)
}
