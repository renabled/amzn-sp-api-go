...
func (m *SubmitShipmentConfirmationsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SubmitShipmentConfirmationsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *SubmitShipmentConfirmationsResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *SubmitShipmentConfirmationsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubmitShipmentConfirmationsResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubmitShipmentConfirmationsResponse) UnmarshalBinary(b []byte) error {
	var res SubmitShipmentConfirmationsResponse
