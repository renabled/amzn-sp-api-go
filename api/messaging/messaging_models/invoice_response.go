...
func (m *InvoiceResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *InvoiceResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
