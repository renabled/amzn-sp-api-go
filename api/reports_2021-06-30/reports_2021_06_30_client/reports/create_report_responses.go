...
func (o *CreateReportAccepted) Error() string {
	return fmt.Sprintf("[POST /reports/2021-06-30/reports][%d] createReportAccepted  %+v", 202, o.Payload)
}
...
func (o *CreateReportAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(reports_2021_06_30_models.CreateReportResponse)
...
func (o *CreateReportBadRequest) Error() string {
	return fmt.Sprintf("[POST /reports/2021-06-30/reports][%d] createReportBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateReportUnauthorized) Error() string {
	return fmt.Sprintf("[POST /reports/2021-06-30/reports][%d] createReportUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CreateReportForbidden) Error() string {
	return fmt.Sprintf("[POST /reports/2021-06-30/reports][%d] createReportForbidden  %+v", 403, o.Payload)
}
...
func (o *CreateReportNotFound) Error() string {
	return fmt.Sprintf("[POST /reports/2021-06-30/reports][%d] createReportNotFound  %+v", 404, o.Payload)
}
...
func (o *CreateReportUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[POST /reports/2021-06-30/reports][%d] createReportUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *CreateReportTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /reports/2021-06-30/reports][%d] createReportTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *CreateReportInternalServerError) Error() string {
	return fmt.Sprintf("[POST /reports/2021-06-30/reports][%d] createReportInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateReportServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /reports/2021-06-30/reports][%d] createReportServiceUnavailable  %+v", 503, o.Payload)
}
