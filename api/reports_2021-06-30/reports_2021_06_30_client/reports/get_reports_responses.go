...
func (o *GetReportsOK) Error() string {
	return fmt.Sprintf("[GET /reports/2021-06-30/reports][%d] getReportsOK  %+v", 200, o.Payload)
}
...
func (o *GetReportsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(reports_2021_06_30_models.GetReportsResponse)
...
func (o *GetReportsBadRequest) Error() string {
	return fmt.Sprintf("[GET /reports/2021-06-30/reports][%d] getReportsBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetReportsUnauthorized) Error() string {
	return fmt.Sprintf("[GET /reports/2021-06-30/reports][%d] getReportsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetReportsForbidden) Error() string {
	return fmt.Sprintf("[GET /reports/2021-06-30/reports][%d] getReportsForbidden  %+v", 403, o.Payload)
}
...
func (o *GetReportsNotFound) Error() string {
	return fmt.Sprintf("[GET /reports/2021-06-30/reports][%d] getReportsNotFound  %+v", 404, o.Payload)
}
...
func (o *GetReportsUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /reports/2021-06-30/reports][%d] getReportsUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *GetReportsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /reports/2021-06-30/reports][%d] getReportsTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetReportsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /reports/2021-06-30/reports][%d] getReportsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetReportsServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /reports/2021-06-30/reports][%d] getReportsServiceUnavailable  %+v", 503, o.Payload)
}
