...
func (m *ItemClassificationSalesRank) validateClassificationID(formats strfmt.Registry) error {
...
func (m *ItemClassificationSalesRank) validateRank(formats strfmt.Registry) error {
...
func (m *ItemClassificationSalesRank) validateTitle(formats strfmt.Registry) error {
...
func (m *ItemClassificationSalesRank) UnmarshalBinary(b []byte) error {
	var res ItemClassificationSalesRank
