...
func (o *CreateQueryParams) WithBody(body *data_kiosk_2023_11_15_models.CreateQuerySpecification) *CreateQueryParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create query params
func (o *CreateQueryParams) SetBody(body *data_kiosk_2023_11_15_models.CreateQuerySpecification) {
	o.Body = body
}
