...
func (o *SubmitAcknowledgementParams) WithBody(body *vendor_orders_models.SubmitAcknowledgementRequest) *SubmitAcknowledgementParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the submit acknowledgement params
func (o *SubmitAcknowledgementParams) SetBody(body *vendor_orders_models.SubmitAcknowledgementRequest) {
	o.Body = body
}
