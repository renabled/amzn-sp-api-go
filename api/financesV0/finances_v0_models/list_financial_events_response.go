...
func (m *ListFinancialEventsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ListFinancialEventsResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *ListFinancialEventsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ListFinancialEventsResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ListFinancialEventsResponse) UnmarshalBinary(b []byte) error {
	var res ListFinancialEventsResponse
