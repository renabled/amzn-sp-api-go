...
func (m NetworkComminglingTransactionEventList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m NetworkComminglingTransactionEventList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
