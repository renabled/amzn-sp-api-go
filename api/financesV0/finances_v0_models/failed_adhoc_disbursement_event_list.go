...
func (m *FailedAdhocDisbursementEventList) validatePostedDate(formats strfmt.Registry) error {
...
func (m *FailedAdhocDisbursementEventList) validateTransferAmount(formats strfmt.Registry) error {
...
func (m *FailedAdhocDisbursementEventList) contextValidatePostedDate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailedAdhocDisbursementEventList) contextValidateTransferAmount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailedAdhocDisbursementEventList) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FailedAdhocDisbursementEventList) UnmarshalBinary(b []byte) error {
	var res FailedAdhocDisbursementEventList
