...
func (m *GetPricingResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetPricingResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetPricingResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetPricingResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
