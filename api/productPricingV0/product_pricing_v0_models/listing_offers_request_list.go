...
func (m ListingOffersRequestList) Validate(formats strfmt.Registry) error {
	...
	iListingOffersRequestListSize := int64(len(m))

	if err := validate.MinItems("", "body", iListingOffersRequestListSize, 1); err != nil {
		return err
	}

	if err := validate.MaxItems("", "body", iListingOffersRequestListSize, 20); err != nil {
		return err
	}
