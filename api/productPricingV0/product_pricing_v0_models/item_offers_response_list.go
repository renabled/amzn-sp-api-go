...
func (m ItemOffersResponseList) Validate(formats strfmt.Registry) error {
	...
	iItemOffersResponseListSize := int64(len(m))

	if err := validate.MinItems("", "body", iItemOffersResponseListSize, 1); err != nil {
		return err
	}

	if err := validate.MaxItems("", "body", iItemOffersResponseListSize, 20); err != nil {
		return err
	}
