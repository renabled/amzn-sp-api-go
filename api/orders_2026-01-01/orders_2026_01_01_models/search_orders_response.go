...
type SearchOrdersResponse struct {
	...
	// Format: date-time
	LastUpdatedBefore strfmt.DateTime `json:"lastUpdatedBefore,omitempty"`
...
func (m *SearchOrdersResponse) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateLastUpdatedBefore(formats); err != nil {
		res = append(res, err)
	}
...
func (m *SearchOrdersResponse) validateCreatedBefore(formats strfmt.Registry) error {
...
func (m *SearchOrdersResponse) validateLastUpdatedBefore(formats strfmt.Registry) error {
	if swag.IsZero(m.LastUpdatedBefore) { // not required
		return nil
	}

	if err := validate.FormatOf("lastUpdatedBefore", "body", "date-time", m.LastUpdatedBefore.String(), formats); err != nil {
		return err
	}
...
func (m *SearchOrdersResponse) validatePagination(formats strfmt.Registry) error {
...
func (m *SearchOrdersResponse) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
