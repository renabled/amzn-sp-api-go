...
type GetOrderOK struct {
	...
	Payload *orders_2026_01_01_models.GetOrderResponse
}
...
func (o *GetOrderOK) Error() string {
	return fmt.Sprintf("[GET /orders/2026-01-01/orders/{orderId}][%d] getOrderOK  %+v", 200, o.Payload)
}
...
func (o *GetOrderOK) GetPayload() *orders_2026_01_01_models.GetOrderResponse {
	return o.Payload
}
...
func (o *GetOrderOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(orders_2026_01_01_models.GetOrderResponse)
...
func (o *GetOrderBadRequest) Error() string {
	return fmt.Sprintf("[GET /orders/2026-01-01/orders/{orderId}][%d] getOrderBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetOrderBadRequest) GetPayload() *orders_2026_01_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderForbidden) Error() string {
	return fmt.Sprintf("[GET /orders/2026-01-01/orders/{orderId}][%d] getOrderForbidden  %+v", 403, o.Payload)
}
...
func (o *GetOrderForbidden) GetPayload() *orders_2026_01_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderNotFound) Error() string {
	return fmt.Sprintf("[GET /orders/2026-01-01/orders/{orderId}][%d] getOrderNotFound  %+v", 404, o.Payload)
}
...
func (o *GetOrderNotFound) GetPayload() *orders_2026_01_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[GET /orders/2026-01-01/orders/{orderId}][%d] getOrderRequestEntityTooLarge  %+v", 413, o.Payload)
}
...
func (o *GetOrderRequestEntityTooLarge) GetPayload() *orders_2026_01_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /orders/2026-01-01/orders/{orderId}][%d] getOrderUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *GetOrderUnsupportedMediaType) GetPayload() *orders_2026_01_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /orders/2026-01-01/orders/{orderId}][%d] getOrderTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetOrderTooManyRequests) GetPayload() *orders_2026_01_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderInternalServerError) Error() string {
	return fmt.Sprintf("[GET /orders/2026-01-01/orders/{orderId}][%d] getOrderInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetOrderInternalServerError) GetPayload() *orders_2026_01_01_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /orders/2026-01-01/orders/{orderId}][%d] getOrderServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *GetOrderServiceUnavailable) GetPayload() *orders_2026_01_01_models.ErrorList {
	return o.Payload
}
