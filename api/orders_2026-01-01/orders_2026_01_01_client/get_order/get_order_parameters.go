...
// WithIncludedData adds the includedData to the get order params
func (o *GetOrderParams) WithIncludedData(includedData []string) *GetOrderParams {
	o.SetIncludedData(includedData)
	return o
}

// SetIncludedData adds the includedData to the get order params
func (o *GetOrderParams) SetIncludedData(includedData []string) {
...
// bindParamGetOrder binds the parameter includedData
func (o *GetOrderParams) bindParamIncludedData(formats strfmt.Registry) []string {
