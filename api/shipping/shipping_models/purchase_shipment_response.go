...
func (m *PurchaseShipmentResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *PurchaseShipmentResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *PurchaseShipmentResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PurchaseShipmentResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PurchaseShipmentResponse) UnmarshalBinary(b []byte) error {
	var res PurchaseShipmentResponse
