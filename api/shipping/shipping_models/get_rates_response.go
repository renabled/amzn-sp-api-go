...
func (m *GetRatesResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetRatesResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetRatesResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetRatesResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
