...
func (o *PutListingsItemParams) WithBody(body *listings_items_2021_08_01_models.ListingsItemPutRequest) *PutListingsItemParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put listings item params
func (o *PutListingsItemParams) SetBody(body *listings_items_2021_08_01_models.ListingsItemPutRequest) {
	o.Body = body
}
