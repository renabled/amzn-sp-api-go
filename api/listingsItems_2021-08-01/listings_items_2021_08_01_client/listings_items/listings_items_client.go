...
// New creates a new listings items API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for listings items API
*/
type Client struct {
...
/*
	DeleteListingsItem deletes listings item
...
/*
	GetListingsItem gets listings item
...
/*
	PatchListingsItem patches listings item
...
/*
	PutListingsItem puts listings item
...
/*
	SearchListingsItems searches listings items
