...
type CreateReportParams struct {
	...
	// Body.
	Body *reports_2020_09_04_models.CreateReportSpecification
...
func (o *CreateReportParams) WithBody(body *reports_2020_09_04_models.CreateReportSpecification) *CreateReportParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create report params
func (o *CreateReportParams) SetBody(body *reports_2020_09_04_models.CreateReportSpecification) {
	o.Body = body
}
