...
func (m *CreateReportResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CreateReportResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *CreateReportResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateReportResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
