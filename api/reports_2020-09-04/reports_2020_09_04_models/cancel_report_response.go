...
func (m *CancelReportResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CancelReportResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
