...
func (m *GetReportScheduleResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetReportScheduleResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetReportScheduleResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetReportScheduleResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetReportScheduleResponse) UnmarshalBinary(b []byte) error {
	var res GetReportScheduleResponse
