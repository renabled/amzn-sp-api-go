...
func (m *GetReportsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetReportsResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetReportsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetReportsResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
