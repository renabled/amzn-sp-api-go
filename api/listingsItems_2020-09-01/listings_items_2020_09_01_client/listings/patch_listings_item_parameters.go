...
type PatchListingsItemParams struct {
	...
	*/
	Body *listings_items_2020_09_01_models.ListingsItemPatchRequest
...
func (o *PatchListingsItemParams) WithBody(body *listings_items_2020_09_01_models.ListingsItemPatchRequest) *PatchListingsItemParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch listings item params
func (o *PatchListingsItemParams) SetBody(body *listings_items_2020_09_01_models.ListingsItemPatchRequest) {
	o.Body = body
}
