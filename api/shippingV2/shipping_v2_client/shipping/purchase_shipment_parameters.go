...
func (o *PurchaseShipmentParams) WithBody(body *shipping_v2_models.PurchaseShipmentRequest) *PurchaseShipmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the purchase shipment params
func (o *PurchaseShipmentParams) SetBody(body *shipping_v2_models.PurchaseShipmentRequest) {
	o.Body = body
}
