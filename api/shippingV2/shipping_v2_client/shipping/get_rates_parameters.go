...
func (o *GetRatesParams) WithBody(body *shipping_v2_models.GetRatesRequest) *GetRatesParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get rates params
func (o *GetRatesParams) SetBody(body *shipping_v2_models.GetRatesRequest) {
	o.Body = body
}
