...
func (o *CancelShipmentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 413:
		result := NewCancelShipmentRequestEntityTooLarge()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 415:
		result := NewCancelShipmentUnsupportedMediaType()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *CancelShipmentOK) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentOK  %+v", 200, o.Payload)
}
...
func (o *CancelShipmentOK) GetPayload() *shipping_v2_models.CancelShipmentResponse {
	return o.Payload
}
...
func (o *CancelShipmentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(shipping_v2_models.CancelShipmentResponse)
...
func (o *CancelShipmentBadRequest) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentBadRequest  %+v", 400, o.Payload)
}
...
func (o *CancelShipmentBadRequest) GetPayload() *shipping_v2_models.ErrorList {
	return o.Payload
}
...
func (o *CancelShipmentUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CancelShipmentUnauthorized) GetPayload() *shipping_v2_models.ErrorList {
	return o.Payload
}
...
func (o *CancelShipmentForbidden) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentForbidden  %+v", 403, o.Payload)
}
...
func (o *CancelShipmentForbidden) GetPayload() *shipping_v2_models.ErrorList {
	return o.Payload
}
...
func (o *CancelShipmentNotFound) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentNotFound  %+v", 404, o.Payload)
}
...
func (o *CancelShipmentNotFound) GetPayload() *shipping_v2_models.ErrorList {
	return o.Payload
}
...
func NewCancelShipmentRequestEntityTooLarge() *CancelShipmentRequestEntityTooLarge {
	return &CancelShipmentRequestEntityTooLarge{}
}
...
func (o *CancelShipmentRequestEntityTooLarge) IsSuccess() bool {
	return false
}
...
func (o *CancelShipmentRequestEntityTooLarge) IsCode(code int) bool {
	return code == 413
}

func (o *CancelShipmentRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *CancelShipmentRequestEntityTooLarge) String() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *CancelShipmentRequestEntityTooLarge) GetPayload() *shipping_v2_models.ErrorList {
	return o.Payload
}

func (o *CancelShipmentRequestEntityTooLarge) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCancelShipmentUnsupportedMediaType() *CancelShipmentUnsupportedMediaType {
	return &CancelShipmentUnsupportedMediaType{}
}
...
func (o *CancelShipmentUnsupportedMediaType) IsSuccess() bool {
	return false
}
...
func (o *CancelShipmentUnsupportedMediaType) IsCode(code int) bool {
	return code == 415
}

func (o *CancelShipmentUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentUnsupportedMediaType  %+v", 415, o.Payload)
}

func (o *CancelShipmentUnsupportedMediaType) String() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentUnsupportedMediaType  %+v", 415, o.Payload)
}

func (o *CancelShipmentUnsupportedMediaType) GetPayload() *shipping_v2_models.ErrorList {
	return o.Payload
}

func (o *CancelShipmentUnsupportedMediaType) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *CancelShipmentTooManyRequests) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *CancelShipmentTooManyRequests) GetPayload() *shipping_v2_models.ErrorList {
	return o.Payload
}
...
func (o *CancelShipmentInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CancelShipmentInternalServerError) GetPayload() *shipping_v2_models.ErrorList {
	return o.Payload
}
...
func (o *CancelShipmentServiceUnavailable) Error() string {
	return fmt.Sprintf("[PUT /shipping/v2/shipments/{shipmentId}/cancel][%d] cancelShipmentServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *CancelShipmentServiceUnavailable) GetPayload() *shipping_v2_models.ErrorList {
	return o.Payload
}
