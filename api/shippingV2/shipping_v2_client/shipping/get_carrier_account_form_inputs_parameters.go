...
// NewGetCarrierAccountFormInputsParams creates a new GetCarrierAccountFormInputsParams object,
...
func NewGetCarrierAccountFormInputsParams() *GetCarrierAccountFormInputsParams {
	return &GetCarrierAccountFormInputsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetCarrierAccountFormInputsParamsWithTimeout creates a new GetCarrierAccountFormInputsParams object
...
// NewGetCarrierAccountFormInputsParamsWithContext creates a new GetCarrierAccountFormInputsParams object
...
// NewGetCarrierAccountFormInputsParamsWithHTTPClient creates a new GetCarrierAccountFormInputsParams object
...
func (o *GetCarrierAccountFormInputsParams) WithDefaults() *GetCarrierAccountFormInputsParams {
	o.SetDefaults()
	return o
}
...
func (o *GetCarrierAccountFormInputsParams) WithTimeout(timeout time.Duration) *GetCarrierAccountFormInputsParams {
...
func (o *GetCarrierAccountFormInputsParams) WithContext(ctx context.Context) *GetCarrierAccountFormInputsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get carrier account form inputs params
func (o *GetCarrierAccountFormInputsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get carrier account form inputs params
func (o *GetCarrierAccountFormInputsParams) WithHTTPClient(client *http.Client) *GetCarrierAccountFormInputsParams {
...
func (o *GetCarrierAccountFormInputsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
