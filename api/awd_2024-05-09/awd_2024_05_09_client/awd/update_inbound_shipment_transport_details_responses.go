...
func (o *UpdateInboundShipmentTransportDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewUpdateInboundShipmentTransportDetailsNoContent()
...
// NewUpdateInboundShipmentTransportDetailsNoContent creates a UpdateInboundShipmentTransportDetailsNoContent with default headers values
func NewUpdateInboundShipmentTransportDetailsNoContent() *UpdateInboundShipmentTransportDetailsNoContent {
	return &UpdateInboundShipmentTransportDetailsNoContent{}
}

/*
UpdateInboundShipmentTransportDetailsNoContent describes a response with status code 204, with default header values.

The 204 response for `updateInboundShipmentTransportDetails`.
*/
type UpdateInboundShipmentTransportDetailsNoContent struct {
...
// IsSuccess returns true when this update inbound shipment transport details no content response has a 2xx status code
func (o *UpdateInboundShipmentTransportDetailsNoContent) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update inbound shipment transport details no content response has a 3xx status code
func (o *UpdateInboundShipmentTransportDetailsNoContent) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update inbound shipment transport details no content response has a 4xx status code
func (o *UpdateInboundShipmentTransportDetailsNoContent) IsClientError() bool {
	return false
}

// IsServerError returns true when this update inbound shipment transport details no content response has a 5xx status code
func (o *UpdateInboundShipmentTransportDetailsNoContent) IsServerError() bool {
	return false
}

// IsCode returns true when this update inbound shipment transport details no content response a status code equal to that given
func (o *UpdateInboundShipmentTransportDetailsNoContent) IsCode(code int) bool {
	return code == 204
}

func (o *UpdateInboundShipmentTransportDetailsNoContent) Error() string {
	return fmt.Sprintf("[PUT /awd/2024-05-09/inboundShipments/{shipmentId}/transport][%d] updateInboundShipmentTransportDetailsNoContent ", 204)
}

func (o *UpdateInboundShipmentTransportDetailsNoContent) String() string {
	return fmt.Sprintf("[PUT /awd/2024-05-09/inboundShipments/{shipmentId}/transport][%d] updateInboundShipmentTransportDetailsNoContent ", 204)
}

func (o *UpdateInboundShipmentTransportDetailsNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
