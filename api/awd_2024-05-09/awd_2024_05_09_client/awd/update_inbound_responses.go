...
func (o *UpdateInboundReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewUpdateInboundNoContent()
...
// NewUpdateInboundNoContent creates a UpdateInboundNoContent with default headers values
func NewUpdateInboundNoContent() *UpdateInboundNoContent {
	return &UpdateInboundNoContent{}
}

/*
UpdateInboundNoContent describes a response with status code 204, with default header values.

The 204 response for `updateInbound`.
*/
type UpdateInboundNoContent struct {
...
// IsSuccess returns true when this update inbound no content response has a 2xx status code
func (o *UpdateInboundNoContent) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update inbound no content response has a 3xx status code
func (o *UpdateInboundNoContent) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update inbound no content response has a 4xx status code
func (o *UpdateInboundNoContent) IsClientError() bool {
	return false
}

// IsServerError returns true when this update inbound no content response has a 5xx status code
func (o *UpdateInboundNoContent) IsServerError() bool {
	return false
}

// IsCode returns true when this update inbound no content response a status code equal to that given
func (o *UpdateInboundNoContent) IsCode(code int) bool {
	return code == 204
}

func (o *UpdateInboundNoContent) Error() string {
	return fmt.Sprintf("[PUT /awd/2024-05-09/inboundOrders/{orderId}][%d] updateInboundNoContent ", 204)
}

func (o *UpdateInboundNoContent) String() string {
	return fmt.Sprintf("[PUT /awd/2024-05-09/inboundOrders/{orderId}][%d] updateInboundNoContent ", 204)
}

func (o *UpdateInboundNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
