...
func (m *InboundOrderCreationData) validatePreferences(formats strfmt.Registry) error {
...
func (m *InboundOrderCreationData) contextValidatePreferences(ctx context.Context, formats strfmt.Registry) error {
