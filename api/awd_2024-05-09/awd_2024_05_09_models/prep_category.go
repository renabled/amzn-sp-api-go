...
const (
	...
	// PrepCategoryNOPREP captures enum value "NO_PREP"
	PrepCategoryNOPREP PrepCategory = "NO_PREP"
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["ADULT","BABY","FC_PROVIDED","FRAGILE","GRANULAR","HANGER","LIQUID","PERFORATED","SET","SHARP","SMALL","TEXTILE","NO_PREP","UNKNOWN"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
