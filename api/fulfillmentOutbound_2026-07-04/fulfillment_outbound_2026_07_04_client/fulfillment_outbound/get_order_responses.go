...
func (o *GetOrderReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 413:
		result := NewGetOrderRequestEntityTooLarge()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
type GetOrderOK struct {
	...
	Payload *fulfillment_outbound_2026_07_04_models.GetOrderResponse
}
...
func (o *GetOrderOK) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderOK  %+v", 200, o.Payload)
}
...
func (o *GetOrderOK) GetPayload() *fulfillment_outbound_2026_07_04_models.GetOrderResponse {
	return o.Payload
}
...
func (o *GetOrderOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(fulfillment_outbound_2026_07_04_models.GetOrderResponse)
...
func (o *GetOrderBadRequest) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetOrderBadRequest) GetPayload() *fulfillment_outbound_2026_07_04_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderUnauthorized) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetOrderUnauthorized) GetPayload() *fulfillment_outbound_2026_07_04_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderForbidden) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderForbidden  %+v", 403, o.Payload)
}
...
func (o *GetOrderForbidden) GetPayload() *fulfillment_outbound_2026_07_04_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderNotFound) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderNotFound  %+v", 404, o.Payload)
}
...
func (o *GetOrderNotFound) GetPayload() *fulfillment_outbound_2026_07_04_models.ErrorList {
	return o.Payload
}
...
// NewGetOrderRequestEntityTooLarge creates a GetOrderRequestEntityTooLarge with default headers values
func NewGetOrderRequestEntityTooLarge() *GetOrderRequestEntityTooLarge {
	return &GetOrderRequestEntityTooLarge{}
}

/*
GetOrderRequestEntityTooLarge describes a response with status code 413, with default header values.

The request size exceeded the maximum accepted size.
*/
type GetOrderRequestEntityTooLarge struct {
...
// IsSuccess returns true when this get order request entity too large response has a 2xx status code
func (o *GetOrderRequestEntityTooLarge) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get order request entity too large response has a 3xx status code
func (o *GetOrderRequestEntityTooLarge) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get order request entity too large response has a 4xx status code
func (o *GetOrderRequestEntityTooLarge) IsClientError() bool {
	return true
}

// IsServerError returns true when this get order request entity too large response has a 5xx status code
func (o *GetOrderRequestEntityTooLarge) IsServerError() bool {
	return false
}

// IsCode returns true when this get order request entity too large response a status code equal to that given
func (o *GetOrderRequestEntityTooLarge) IsCode(code int) bool {
	return code == 413
}

func (o *GetOrderRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *GetOrderRequestEntityTooLarge) String() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *GetOrderRequestEntityTooLarge) GetPayload() *fulfillment_outbound_2026_07_04_models.ErrorList {
	return o.Payload
}

func (o *GetOrderRequestEntityTooLarge) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetOrderUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *GetOrderUnsupportedMediaType) GetPayload() *fulfillment_outbound_2026_07_04_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetOrderTooManyRequests) GetPayload() *fulfillment_outbound_2026_07_04_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderInternalServerError) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetOrderInternalServerError) GetPayload() *fulfillment_outbound_2026_07_04_models.ErrorList {
	return o.Payload
}
...
func (o *GetOrderServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /fulfillment/outbound/2026-07-04/orders/{orderId}][%d] getOrderServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *GetOrderServiceUnavailable) GetPayload() *fulfillment_outbound_2026_07_04_models.ErrorList {
	return o.Payload
}
