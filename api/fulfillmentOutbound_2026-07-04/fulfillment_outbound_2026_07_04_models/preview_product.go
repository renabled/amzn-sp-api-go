...
// PreviewProduct Product information for the line item.
//
// swagger:model PreviewProduct
...
// Validate validates this preview product
func (m *PreviewProduct) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PreviewProduct) validatePerUnitDeclaredValue(formats strfmt.Registry) error {
...
func (m *PreviewProduct) validateProductIdentifier(formats strfmt.Registry) error {
...
// ContextValidate validate this preview product based on the context it is used
func (m *PreviewProduct) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PreviewProduct) contextValidatePerUnitDeclaredValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PreviewProduct) contextValidateProductIdentifier(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PreviewProduct) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PreviewProduct) UnmarshalBinary(b []byte) error {
	var res PreviewProduct
