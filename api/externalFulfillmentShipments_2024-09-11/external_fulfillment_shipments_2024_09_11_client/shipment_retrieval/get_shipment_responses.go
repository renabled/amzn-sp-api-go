...
type GetShipmentOK struct {
	...
	Payload *external_fulfillment_shipments_2024_09_11_models.Shipment
}
...
func (o *GetShipmentOK) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentOK  %+v", 200, o.Payload)
}
...
func (o *GetShipmentOK) GetPayload() *external_fulfillment_shipments_2024_09_11_models.Shipment {
	return o.Payload
}
...
func (o *GetShipmentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(external_fulfillment_shipments_2024_09_11_models.Shipment)
...
func (o *GetShipmentBadRequest) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetShipmentBadRequest) GetPayload() *external_fulfillment_shipments_2024_09_11_models.ErrorList {
	return o.Payload
}
...
func (o *GetShipmentForbidden) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentForbidden  %+v", 403, o.Payload)
}
...
func (o *GetShipmentForbidden) GetPayload() *external_fulfillment_shipments_2024_09_11_models.ErrorList {
	return o.Payload
}
...
func (o *GetShipmentNotFound) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentNotFound  %+v", 404, o.Payload)
}
...
func (o *GetShipmentNotFound) GetPayload() *external_fulfillment_shipments_2024_09_11_models.ErrorList {
	return o.Payload
}
...
// NewGetShipmentConflict creates a GetShipmentConflict with default headers values
func NewGetShipmentConflict() *GetShipmentConflict {
	return &GetShipmentConflict{}
}

/*
GetShipmentConflict describes a response with status code 409, with default header values.

The resource specified conflicts with the current state
*/
type GetShipmentConflict struct {
...
// IsSuccess returns true when this get shipment conflict response has a 2xx status code
func (o *GetShipmentConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get shipment conflict response has a 3xx status code
func (o *GetShipmentConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get shipment conflict response has a 4xx status code
func (o *GetShipmentConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this get shipment conflict response has a 5xx status code
func (o *GetShipmentConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this get shipment conflict response a status code equal to that given
func (o *GetShipmentConflict) IsCode(code int) bool {
	return code == 409
}

func (o *GetShipmentConflict) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentConflict  %+v", 409, o.Payload)
}

func (o *GetShipmentConflict) String() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentConflict  %+v", 409, o.Payload)
}

func (o *GetShipmentConflict) GetPayload() *external_fulfillment_shipments_2024_09_11_models.ErrorList {
	return o.Payload
}

func (o *GetShipmentConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetShipmentRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentRequestEntityTooLarge  %+v", 413, o.Payload)
}
...
func (o *GetShipmentRequestEntityTooLarge) GetPayload() *external_fulfillment_shipments_2024_09_11_models.ErrorList {
	return o.Payload
}
...
func (o *GetShipmentUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *GetShipmentUnsupportedMediaType) GetPayload() *external_fulfillment_shipments_2024_09_11_models.ErrorList {
	return o.Payload
}
...
func (o *GetShipmentTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetShipmentTooManyRequests) GetPayload() *external_fulfillment_shipments_2024_09_11_models.ErrorList {
	return o.Payload
}
...
func (o *GetShipmentInternalServerError) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetShipmentInternalServerError) GetPayload() *external_fulfillment_shipments_2024_09_11_models.ErrorList {
	return o.Payload
}
...
func (o *GetShipmentServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /externalFulfillment/2024-09-11/shipments/{shipmentId}][%d] getShipmentServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *GetShipmentServiceUnavailable) GetPayload() *external_fulfillment_shipments_2024_09_11_models.ErrorList {
	return o.Payload
}
