...
// New creates a new shipment retrieval API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for shipment retrieval API
*/
type Client struct {
...
/*
GetShipment Get a single shipment with the ID you specify.
*/
...
/*
GetShipments Get a list of shipments created for the seller in the status you specify. Shipments can be further filtered based on the fulfillment node or the time of the shipments' last update.
*/
