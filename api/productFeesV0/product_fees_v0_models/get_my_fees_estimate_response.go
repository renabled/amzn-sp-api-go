...
func (m *GetMyFeesEstimateResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetMyFeesEstimateResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetMyFeesEstimateResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetMyFeesEstimateResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetMyFeesEstimateResponse) UnmarshalBinary(b []byte) error {
	var res GetMyFeesEstimateResponse
