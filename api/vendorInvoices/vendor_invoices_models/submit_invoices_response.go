...
func (m *SubmitInvoicesResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *SubmitInvoicesResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *SubmitInvoicesResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubmitInvoicesResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubmitInvoicesResponse) UnmarshalBinary(b []byte) error {
	var res SubmitInvoicesResponse
