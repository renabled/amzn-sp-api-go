...
func (m *RangeSlotCapacityErrors) validateErrors(formats strfmt.Registry) error {
...
func (m *RangeSlotCapacityErrors) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RangeSlotCapacityErrors) UnmarshalBinary(b []byte) error {
	var res RangeSlotCapacityErrors
