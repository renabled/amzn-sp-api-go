...
func (m *GetServiceJobByServiceJobIDResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetServiceJobByServiceJobIDResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetServiceJobByServiceJobIDResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetServiceJobByServiceJobIDResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetServiceJobByServiceJobIDResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetServiceJobByServiceJobIDResponse) UnmarshalBinary(b []byte) error {
	var res GetServiceJobByServiceJobIDResponse
