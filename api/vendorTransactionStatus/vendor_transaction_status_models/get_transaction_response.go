...
package vendor_transaction_status_models
...
func (m *GetTransactionResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetTransactionResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetTransactionResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetTransactionResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
