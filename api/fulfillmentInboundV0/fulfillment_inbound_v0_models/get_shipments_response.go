...
func (m *GetShipmentsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetShipmentsResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetShipmentsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetShipmentsResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
