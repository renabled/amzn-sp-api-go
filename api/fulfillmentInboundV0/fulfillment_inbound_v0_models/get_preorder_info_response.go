...
func (m *GetPreorderInfoResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetPreorderInfoResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetPreorderInfoResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetPreorderInfoResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetPreorderInfoResponse) UnmarshalBinary(b []byte) error {
	var res GetPreorderInfoResponse
