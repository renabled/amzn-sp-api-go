...
func (m *PutTransportDetailsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *PutTransportDetailsResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *PutTransportDetailsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PutTransportDetailsResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PutTransportDetailsResponse) UnmarshalBinary(b []byte) error {
	var res PutTransportDetailsResponse
