...
func (m NonPartneredSmallParcelPackageOutputList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m NonPartneredSmallParcelPackageOutputList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
