...
func (m PartneredSmallParcelPackageOutputList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m PartneredSmallParcelPackageOutputList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
