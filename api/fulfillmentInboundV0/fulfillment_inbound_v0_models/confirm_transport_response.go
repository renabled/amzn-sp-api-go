...
func (m *ConfirmTransportResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ConfirmTransportResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *ConfirmTransportResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfirmTransportResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfirmTransportResponse) UnmarshalBinary(b []byte) error {
	var res ConfirmTransportResponse
