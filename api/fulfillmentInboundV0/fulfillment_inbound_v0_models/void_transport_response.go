...
func (m *VoidTransportResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *VoidTransportResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *VoidTransportResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VoidTransportResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
