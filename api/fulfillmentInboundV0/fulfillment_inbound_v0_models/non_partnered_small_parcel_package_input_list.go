...
func (m NonPartneredSmallParcelPackageInputList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m NonPartneredSmallParcelPackageInputList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
