...
func (m *ConfirmPreorderResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ConfirmPreorderResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *ConfirmPreorderResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfirmPreorderResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfirmPreorderResponse) UnmarshalBinary(b []byte) error {
	var res ConfirmPreorderResponse
