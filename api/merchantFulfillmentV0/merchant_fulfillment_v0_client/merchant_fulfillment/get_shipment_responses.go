...
type GetShipmentOK struct {
	...
	Payload *merchant_fulfillment_v0_models.GetShipmentResponse
}
...
func (o *GetShipmentOK) Error() string {
	return fmt.Sprintf("[GET /mfn/v0/shipments/{shipmentId}][%d] getShipmentOK  %+v", 200, o.Payload)
}
...
func (o *GetShipmentOK) GetPayload() *merchant_fulfillment_v0_models.GetShipmentResponse {
	return o.Payload
}
...
func (o *GetShipmentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(merchant_fulfillment_v0_models.GetShipmentResponse)
...
func (o *GetShipmentBadRequest) Error() string {
	return fmt.Sprintf("[GET /mfn/v0/shipments/{shipmentId}][%d] getShipmentBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetShipmentBadRequest) GetPayload() *merchant_fulfillment_v0_models.GetShipmentResponse {
	return o.Payload
}
...
func (o *GetShipmentUnauthorized) Error() string {
	return fmt.Sprintf("[GET /mfn/v0/shipments/{shipmentId}][%d] getShipmentUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetShipmentUnauthorized) GetPayload() *merchant_fulfillment_v0_models.GetShipmentResponse {
	return o.Payload
}
...
func (o *GetShipmentForbidden) Error() string {
	return fmt.Sprintf("[GET /mfn/v0/shipments/{shipmentId}][%d] getShipmentForbidden  %+v", 403, o.Payload)
}
...
func (o *GetShipmentForbidden) GetPayload() *merchant_fulfillment_v0_models.GetShipmentResponse {
	return o.Payload
}
...
func (o *GetShipmentNotFound) Error() string {
	return fmt.Sprintf("[GET /mfn/v0/shipments/{shipmentId}][%d] getShipmentNotFound  %+v", 404, o.Payload)
}
...
func (o *GetShipmentNotFound) GetPayload() *merchant_fulfillment_v0_models.GetShipmentResponse {
	return o.Payload
}
...
func (o *GetShipmentTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /mfn/v0/shipments/{shipmentId}][%d] getShipmentTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetShipmentTooManyRequests) GetPayload() *merchant_fulfillment_v0_models.GetShipmentResponse {
	return o.Payload
}
...
func (o *GetShipmentInternalServerError) Error() string {
	return fmt.Sprintf("[GET /mfn/v0/shipments/{shipmentId}][%d] getShipmentInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetShipmentInternalServerError) GetPayload() *merchant_fulfillment_v0_models.GetShipmentResponse {
	return o.Payload
}
...
func (o *GetShipmentServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /mfn/v0/shipments/{shipmentId}][%d] getShipmentServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *GetShipmentServiceUnavailable) GetPayload() *merchant_fulfillment_v0_models.GetShipmentResponse {
	return o.Payload
}
