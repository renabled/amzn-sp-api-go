...
func (m *CancelShipmentResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CancelShipmentResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *CancelShipmentResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CancelShipmentResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
