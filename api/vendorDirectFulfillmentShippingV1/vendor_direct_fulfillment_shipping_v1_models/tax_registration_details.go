...
func (m *TaxRegistrationDetails) validateTaxRegistrationAddress(formats strfmt.Registry) error {
...
func (m *TaxRegistrationDetails) contextValidateTaxRegistrationAddress(ctx context.Context, formats strfmt.Registry) error {
