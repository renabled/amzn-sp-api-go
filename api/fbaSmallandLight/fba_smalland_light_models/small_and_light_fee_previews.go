...
func (m *SmallAndLightFeePreviews) validateData(formats strfmt.Registry) error {
...
func (m *SmallAndLightFeePreviews) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SmallAndLightFeePreviews) UnmarshalBinary(b []byte) error {
	var res SmallAndLightFeePreviews
