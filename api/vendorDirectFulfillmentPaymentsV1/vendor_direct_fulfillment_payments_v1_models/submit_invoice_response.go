...
func (m *SubmitInvoiceResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *SubmitInvoiceResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
