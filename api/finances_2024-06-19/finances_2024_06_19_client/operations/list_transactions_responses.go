...
import (
	...
	"github.com/renabled/amzn-sp-api-go/api/finances_2024-06-19/finances_2024_06_19_models"
)
...
func (o *ListTransactionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 413:
		result := NewListTransactionsRequestEntityTooLarge()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 415:
		result := NewListTransactionsUnsupportedMediaType()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListTransactionsOK) Error() string {
	return fmt.Sprintf("[GET /finances/2024-06-19/transactions][%d] listTransactionsOK  %+v", 200, o.Payload)
}
...
func (o *ListTransactionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(finances_2024_06_19_models.ListTransactionsResponse)
...
func (o *ListTransactionsBadRequest) Error() string {
	return fmt.Sprintf("[GET /finances/2024-06-19/transactions][%d] listTransactionsBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListTransactionsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(finances_2024_06_19_models.ErrorList)
...
func (o *ListTransactionsForbidden) Error() string {
	return fmt.Sprintf("[GET /finances/2024-06-19/transactions][%d] listTransactionsForbidden  %+v", 403, o.Payload)
}
...
func (o *ListTransactionsNotFound) Error() string {
	return fmt.Sprintf("[GET /finances/2024-06-19/transactions][%d] listTransactionsNotFound  %+v", 404, o.Payload)
}
...
func NewListTransactionsRequestEntityTooLarge() *ListTransactionsRequestEntityTooLarge {
	return &ListTransactionsRequestEntityTooLarge{}
}
...
func (o *ListTransactionsRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[GET /finances/2024-06-19/transactions][%d] listTransactionsRequestEntityTooLarge  %+v", 413, o.Payload)
}
...
func (o *ListTransactionsRequestEntityTooLarge) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewListTransactionsUnsupportedMediaType() *ListTransactionsUnsupportedMediaType {
	return &ListTransactionsUnsupportedMediaType{}
}
...
func (o *ListTransactionsUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /finances/2024-06-19/transactions][%d] listTransactionsUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *ListTransactionsUnsupportedMediaType) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListTransactionsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /finances/2024-06-19/transactions][%d] listTransactionsTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *ListTransactionsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /finances/2024-06-19/transactions][%d] listTransactionsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListTransactionsServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /finances/2024-06-19/transactions][%d] listTransactionsServiceUnavailable  %+v", 503, o.Payload)
}
