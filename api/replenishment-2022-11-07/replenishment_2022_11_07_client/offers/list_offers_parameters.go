...
func (o *ListOffersParams) WithBody(body *replenishment_2022_11_07_models.ListOffersRequest) *ListOffersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the list offers params
func (o *ListOffersParams) SetBody(body *replenishment_2022_11_07_models.ListOffersRequest) {
	o.Body = body
}
