...
// NewListOfferMetricsParams creates a new ListOfferMetricsParams object,
...
func NewListOfferMetricsParams() *ListOfferMetricsParams {
	return &ListOfferMetricsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListOfferMetricsParamsWithTimeout creates a new ListOfferMetricsParams object
...
// NewListOfferMetricsParamsWithContext creates a new ListOfferMetricsParams object
...
// NewListOfferMetricsParamsWithHTTPClient creates a new ListOfferMetricsParams object
...
func (o *ListOfferMetricsParams) WithDefaults() *ListOfferMetricsParams {
	o.SetDefaults()
	return o
}
...
func (o *ListOfferMetricsParams) WithTimeout(timeout time.Duration) *ListOfferMetricsParams {
...
func (o *ListOfferMetricsParams) WithContext(ctx context.Context) *ListOfferMetricsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ListOfferMetricsParams) WithBody(body *replenishment_2022_11_07_models.ListOfferMetricsRequest) *ListOfferMetricsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the list offer metrics params
func (o *ListOfferMetricsParams) SetBody(body *replenishment_2022_11_07_models.ListOfferMetricsRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *ListOfferMetricsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
