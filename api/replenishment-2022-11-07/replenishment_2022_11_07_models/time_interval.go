...
// TimeInterval A date-time interval in ISO 8601 format used to compute metrics. Only the date is required, but you must pass the complete date and time value. For example, November 11, 2022 should be passed as "2022-11-11T00:00:00Z". Note that only data for the trailing 2 years is supported.
//
// **Note**:
...
type TimeInterval struct {
	...
	// * For `WEEK` the metric is computed from the first day of the week (Monday, based on ISO 8601) that contains the `startDate`.
