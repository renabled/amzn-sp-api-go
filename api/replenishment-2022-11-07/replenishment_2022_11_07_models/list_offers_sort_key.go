...
const (
	...
	// ListOffersSortKeyINVENTORY captures enum value "INVENTORY"
	ListOffersSortKeyINVENTORY ListOffersSortKey = "INVENTORY"

	// ListOffersSortKeyPRICE captures enum value "PRICE"
	ListOffersSortKeyPRICE ListOffersSortKey = "PRICE"

	// ListOffersSortKeySUBSCRIPTIONCOUNT captures enum value "SUBSCRIPTION_COUNT"
	ListOffersSortKeySUBSCRIPTIONCOUNT ListOffersSortKey = "SUBSCRIPTION_COUNT"

	// ListOffersSortKeyFULFILLMENTNETWORKIDTYPE captures enum value "FULFILLMENT_NETWORK_ID_TYPE"
	ListOffersSortKeyFULFILLMENTNETWORKIDTYPE ListOffersSortKey = "FULFILLMENT_NETWORK_ID_TYPE"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["ASIN","SELLING_PARTNER_FUNDED_BASE_DISCOUNT_PERCENTAGE","SELLING_PARTNER_FUNDED_TIERED_DISCOUNT_PERCENTAGE","AMAZON_FUNDED_BASE_DISCOUNT_PERCENTAGE","AMAZON_FUNDED_TIERED_DISCOUNT_PERCENTAGE","INVENTORY","PRICE","SUBSCRIPTION_COUNT","FULFILLMENT_NETWORK_ID_TYPE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
