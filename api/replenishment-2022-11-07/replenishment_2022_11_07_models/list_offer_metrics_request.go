...
func (m *ListOfferMetricsRequest) validateFilters(formats strfmt.Registry) error {
...
func (m *ListOfferMetricsRequest) validatePagination(formats strfmt.Registry) error {
...
func (m *ListOfferMetricsRequest) validateSort(formats strfmt.Registry) error {
...
func (m *ListOfferMetricsRequest) contextValidateFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ListOfferMetricsRequest) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ListOfferMetricsRequest) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ListOfferMetricsRequest) UnmarshalBinary(b []byte) error {
	var res ListOfferMetricsRequest
