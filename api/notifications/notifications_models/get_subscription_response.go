...
func (m *GetSubscriptionResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetSubscriptionResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetSubscriptionResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSubscriptionResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSubscriptionResponse) UnmarshalBinary(b []byte) error {
	var res GetSubscriptionResponse
