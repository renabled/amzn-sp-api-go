...
func (m *CreateDestinationResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CreateDestinationResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *CreateDestinationResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateDestinationResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateDestinationResponse) UnmarshalBinary(b []byte) error {
	var res CreateDestinationResponse
