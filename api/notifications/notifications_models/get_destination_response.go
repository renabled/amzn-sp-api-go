...
func (m *GetDestinationResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetDestinationResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetDestinationResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetDestinationResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetDestinationResponse) UnmarshalBinary(b []byte) error {
	var res GetDestinationResponse
