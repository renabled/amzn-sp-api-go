...
type CreateFeedDocumentParams struct {
	...
	// Body.
	Body *feeds_2020_09_04_models.CreateFeedDocumentSpecification
...
func (o *CreateFeedDocumentParams) WithBody(body *feeds_2020_09_04_models.CreateFeedDocumentSpecification) *CreateFeedDocumentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create feed document params
func (o *CreateFeedDocumentParams) SetBody(body *feeds_2020_09_04_models.CreateFeedDocumentSpecification) {
	o.Body = body
}
