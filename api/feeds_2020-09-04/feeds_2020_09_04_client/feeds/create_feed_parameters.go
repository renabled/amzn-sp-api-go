...
type CreateFeedParams struct {
	...
	// Body.
	Body *feeds_2020_09_04_models.CreateFeedSpecification
...
func (o *CreateFeedParams) WithBody(body *feeds_2020_09_04_models.CreateFeedSpecification) *CreateFeedParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create feed params
func (o *CreateFeedParams) SetBody(body *feeds_2020_09_04_models.CreateFeedSpecification) {
	o.Body = body
}
