...
func (m *GetFeedDocumentResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetFeedDocumentResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *GetFeedDocumentResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetFeedDocumentResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetFeedDocumentResponse) UnmarshalBinary(b []byte) error {
	var res GetFeedDocumentResponse
