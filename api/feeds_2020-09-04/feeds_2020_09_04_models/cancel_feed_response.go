...
func (m *CancelFeedResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CancelFeedResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
