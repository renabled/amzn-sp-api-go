...
func (m *ConfirmShipmentErrorResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ConfirmShipmentErrorResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfirmShipmentErrorResponse) UnmarshalBinary(b []byte) error {
	var res ConfirmShipmentErrorResponse
