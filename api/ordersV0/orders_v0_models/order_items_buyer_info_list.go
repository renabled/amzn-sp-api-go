...
func (m *OrderItemsBuyerInfoList) validateAmazonOrderID(formats strfmt.Registry) error {
...
func (m *OrderItemsBuyerInfoList) validateOrderItems(formats strfmt.Registry) error {
...
func (m *OrderItemsBuyerInfoList) contextValidateOrderItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderItemsBuyerInfoList) UnmarshalBinary(b []byte) error {
	var res OrderItemsBuyerInfoList
